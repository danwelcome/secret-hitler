...
if (process.env.NODE_ENV !== 'production') {
	...
	store = new MongoDBStore({
		uri: `mongodb://${process.env.MONGO_HOSTNAME}/secret-hitler-app`,
		collection: 'sessions'
	});
} else {
...
mongoose.connect(`mongodb://${process.env.MONGO_HOSTNAME}/secret-hitler-app`, { useNewUrlParser: true, useUnifiedTopology: true });
